...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startStopButton.setOnClickListener {
            ...
            when {
                message.isEmpty() -> showToast("Please enter a message.")
                phoneNumber.isEmpty() -> showToast("Please enter a phone number.")
                !isPhoneNumberValid(phoneNumber) -> showToast("Please enter a valid 10-digit phone number.")
                timeString.isEmpty() -> showToast("Please enter the time interval.")
